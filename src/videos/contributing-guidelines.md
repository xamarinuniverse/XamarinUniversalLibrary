...
1. If you submit the resource `Author`.
1. If you submit the resource `Platform`. (Only the main name of the webpage)
1. If you submit the language code of video `Language`. This language code should be in [ISO 639-1 format](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) \*
